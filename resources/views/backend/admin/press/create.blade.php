    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::open(['method'=>'POST','route'=>['admin.press.store'],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        {!!Form::label('short_description_en','Short Description',['class'=>'col-form-label col-lg-2 require']) !!}
                    ...
                    <div class="form-group">
                        {!!Form::label('long_description_en','Long Description',['class'=>'col-form-label col-lg-2 require']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::input('datetime-local', 'published_date', old('published_date'), ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
