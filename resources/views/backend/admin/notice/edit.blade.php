        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><a href="{{route('admin.notice.index')}}"
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($notice,['method'=>'PUT','route'=>['admin.notice.update',$notice->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}

                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!!Form::label('title_en','Title (en)',['class'=>'col-form-label col-lg-2']) !!}
                    ...
                    <div class="form-group">
                        {!!Form::label('description_fr','Description (fr)',['class'=>'col-form-label col-lg-2']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="{{$notice->getImagePathAttribute()}}" width="420px" alt="Press Image">
                            </div>
                        </div>
                    </div>
