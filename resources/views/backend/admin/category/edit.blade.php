    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($category,['method'=>'PUT','route'=>['admin.category.update',$category->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="card">
                                    <img class="card-img-top" src="{{$category->getImagePathAttribute()}}"
                                         alt="Bologna">
                                </div>
                            </div>
                        </div>
