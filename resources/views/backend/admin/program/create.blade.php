    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::open(['method'=>'POST','route'=>['admin.program.store'],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('tags[]', $tags, old('tags'), ['class'=>'form-control select2tags','multiple'=>'multiple']) !!}
