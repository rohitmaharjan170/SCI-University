        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><a href="{{route('admin.program.index')}}"
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($program,['method'=>'PUT','route'=>['admin.program.update',$program->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!!Form::label('category_id','Category',['class'=>'col-form-label']) !!}
                                {!! Form::select('category_id', $category, old('category'), ['class'=>'form-control select2','required','placeholder'=>'']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                {!!Form::label('trainers','Trainers',['class'=>'col-form-label']) !!}
                                {!! Form::select('trainers[]', $trainers, old('trainer'), ['class'=>'form-control select2']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('tags[]', $tags, old('trainer'), ['class'=>'form-control select2tags','multiple'=>'multiple']) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <img src="{{$program->getImagePathAttribute()}}" width="420px" alt="Press Image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <iframe width="560" height="315" src="{{$program->video_url}}" frameborder="0"
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <p class="card-text"><a href="{{route('admin.program.destroy.image.item',$img->id)}}" onclick="return confirm('Are you sure?')" ><i class="fas fa-trash text-danger fa-2x"></i></a></p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @foreach($program->videos as $video)
                                    <div class="card" style="width: 560px;">
                                        <iframe width="560" height="315" src="{{$video->video_url}}" frameborder="0"
                                                allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                        <div class="card-body text-center">
                                            <p class="card-text"><a href="{{route('admin.program.destroy.video.item',$video->id)}}" onclick="return confirm('Are you sure?')"><i class="fas fa-trash text-danger fa-2x"></i></a></p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
