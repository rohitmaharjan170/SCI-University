        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><a href="{{route('admin.companyassociate.index')}}"
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($companyAssociate,['method'=>'PUT','route'=>['admin.companyassociate.update',$companyAssociate->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
                        {!!Form::label('company_name','Company Name',['class'=>'col-form-label col-lg-2 require']) !!}
                        {!! Form::text('company_name',old('company_name'),['class'=>"form-control",'required'=>'required',"maxlength"=>"191"]) !!}
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="{{$companyAssociate->getImagePathAttribute()}}" width="420px" alt="Press Image">
                            </div>
                        </div>
                    </div>
