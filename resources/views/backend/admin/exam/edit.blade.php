    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($exam,['method'=>'PUT','route'=>['admin.exam.update',$exam->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('training_id', $training, old('training_id'), ['class'=>'form-control','placeholder'=>'Select Program or Training']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!!Form::label('time_duration','Time Duration (Minutes)',['class'=>'col-form-label']) !!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::input('datetime-local', 'exam_date', date('Y-m-d\TH:i', strtotime($exam->exam_date)), ['class' => 'form-control datetime']) !!}
