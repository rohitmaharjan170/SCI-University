    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($trainer,['method'=>'PUT','route'=>['admin.trainer.update',$trainer->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="password" class="form-control" value="{{old('password')}}" maxlength='191'>
