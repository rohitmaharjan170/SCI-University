        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><a href="{{route('admin.franchise.index')}}"
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($franchise,['method'=>'PUT','route'=>['admin.franchise.update',$franchise->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="{{$franchise->getImagePathAttribute()}}" width="420px" alt="Press Image">
                            </div>
                        </div>
                    </div>
