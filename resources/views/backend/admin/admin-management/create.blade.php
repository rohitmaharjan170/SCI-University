    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {{--                    {!! Form::open(['method'=>'get','route'=>['admin.manage.store'],'files'=>true]) !!}--}}
                    {!! Form::open(['method'=>'POST','route'=>['admin.manage.store'],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    @foreach($permission as $key => $p)
                                        ...
                                        <ul style="list-style-type:none;">
                                            <li>
                                                ...
                                                {!! Form::checkbox('permission[]', $p->name) !!}
                                            </li>
                                        </ul>
                                    @endforeach
                                </div>
