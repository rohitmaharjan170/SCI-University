        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><a href="{{route('admin.course.index')}}"
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($course,['method'=>'PUT','route'=>['admin.course.update',$course->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!!Form::label('program_id','Program',['class'=>'col-form-label']) !!}
                                {!! Form::select('program_id', $programs, old('program_id'), ['class'=>'form-control select2','required'=>'required','placeholder'=>'']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::number('discount',old('discount'),['class'=>"form-control","maxlength"=>"191"]) !!}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::number('rating',old('rating'),['class'=>"form-control","maxlength"=>"191"]) !!}
                    ...
                    <div class="form-group">
                        {!!Form::label('trainer_id','Trainers',['class'=>'col-form-label']) !!}
                        {!! Form::select('trainer_id', $trainers, old('trainer_id'), ['class'=>'form-control select2multiple']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('tags[]', $tags, old('tags'), ['class'=>'form-control select2multiple','multiple'=>'multiple']) !!}
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                @if ($errors->first('video_url'))
                                    <span class="text-danger"><strong>{{ $errors->first('video_url') }}</strong>
                                        </span>
                                @endif
                            </div>
                        </div>
                ...
                <hr>
                <h5 class="text-center">Main Banner and Video Preview</h5>
                <hr>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <img src="{{$course->getImagePathAttribute()}}" width="420px" alt="Press Image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <hr>
                <h5 class="text-center">Sub Image Banners and Videos Preview</h5>
                <hr>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="row">
                                @foreach($course->images as $image)
                                    <div class="col-md-6 mb-2">
                                        <div class="card">
                                            <img class="card-img-top" src="{{$image->getImagePathAttribute()}}" alt="">
                                            <div class="card-body text-center">
                                                <p class="card-text"><a href="{{route('admin.course.destroy.image.item',$image->id)}}" onclick="return confirm('Are you sure?')" ><i class="fas fa-trash text-danger fa-2x"></i></a></p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="col-md-6">
                                @foreach($course->videos as $video)
                                    <div class="card" style="width: 560px;">
                                        <iframe width="560" height="315" src="{{$video->video_url}}" frameborder="0"
                                                allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                        <div class="card-body text-center">
                                            <p class="card-text"><a href="{{route('admin.course.destroy.video.item',$video->id)}}" onclick="return confirm('Are you sure?')"><i class="fas fa-trash text-danger fa-2x"></i></a></p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
