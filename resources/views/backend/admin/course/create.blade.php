    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::open(['method'=>'POST','route'=>['admin.course.store'],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!!Form::label('program_id','Program',['class'=>'col-form-label']) !!}
                                {!! Form::select('program_id', $programs, old('program_id'), ['class'=>'form-control select2','required','placeholder'=>'']) !!}
                    ...
                    <div class="form-group">
                        {!!Form::label('trainer_id','Trainer',['class'=>'col-form-label']) !!}
                        {!! Form::select('trainer_id', $trainers, old('trainer_id'), ['class'=>'form-control select2trainer','placeholder'=>'']) !!}
