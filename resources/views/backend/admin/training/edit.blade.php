    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($training,['method'=>'PUT','route'=>['admin.training.update',$training->id],'role'=>'form','enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('trainers[]', $trainers, old('trainer'), ['class'=>'form-control select2multiple','multiple'=>'multiple']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('tags[]', $tags, old('trainer'), ['class'=>'form-control select2multiple','multiple'=>'multiple']) !!}
                        @if ($errors->first('trainer'))
                            <span class="text-danger">
                                        <strong>{{ $errors->first('trainer') }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <img src="{{$training->getImagePathAttribute()}}" width="420px" alt="Press Image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <p class="card-text"><a href="{{route('admin.training.destroy.image.item',$image->id)}}" onclick="return confirm('Are you sure?')" ><i class="fas fa-trash text-danger fa-2x"></i></a></p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @foreach($training->videos as $video)
                                    <div class="card" style="width: 560px;">
                                        <iframe width="560" height="315" src="{{$video->video_url}}" frameborder="0"
                                                allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                        <div class="card-body text-center">
                                            <p class="card-text"><a href="{{route('admin.training.destroy.video.item',$video->id)}}" onclick="return confirm('Are you sure?')"><i class="fas fa-trash text-danger fa-2x"></i></a></p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
