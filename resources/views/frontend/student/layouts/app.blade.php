...
@include('frontend.student.includes.navbar')
...
<script type="text/javascript" src="{{asset('frontend/js/TimeCircles.js')}}"></script>
<link href="{{asset('frontend/css/TimeCircles.css')}}" rel="stylesheet">
<!-- jQuery UI 1.11.4 -->
