...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                <a href="{{route('student.course.actions',[encrypt($courseId),'course-menu'])}}"
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <h5>Choose assignment to view your submission files</h5>
            <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="card w-55">
                            ...
                            <div class="card-footer text-center">
                                <a href="{{route('student.show.student.assignment',['course_id'=>encrypt($courseId),'assignment_id'=>encrypt($assignment->id)])}}"
                                   class="btn btn-danger mt-3">View
                                    Submitted Assignment</a>
                            </div>
                        </div>
                    </div>
                @endforeach
