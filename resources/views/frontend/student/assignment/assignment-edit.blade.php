...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title"><a href="{{route('student.show.student.assignment',['assignment_id'=>$assignmentId,'course_id'=>$courseId])}}"
        ...
        <!-- /.card-header -->
        <div class="card-body">
            {!! Form::model($assignmentSubmission,['method'=>'PUT','route'=>['student.assignment.update',encrypt($assignmentSubmission->id)],'role'=>'form','enctype' => 'multipart/form-data']) !!}
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <table class="table table-bordered table-striped mb-5">
                            ...
                            <tbody>
                            @foreach($assignmentSubmission->assignmentsubmissionFiles as $file)
                                <tr>
                                    @php
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('student.assignment.delete.file',$file->id)}}"
