...
class CMSSTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('c_m_s_s')->delete();
        
        \DB::table('c_m_s_s')->insert(array (
            0 => 
            array (
                'id' => 1,
...
<p>Create your mobile-optimized privacy and cookie policy in minutes.<br />
<br />
Customizable from 1300+ clauses, available in 8 languages and automatically updated if the law changes &ndash; our generator allows you to create your policy in minutes and seamlessly integrate it with your app.</p>',
                'status' => '1',
                'created_at' => '2020-11-30 07:48:46',
                'updated_at' => '2020-12-13 08:36:36',
            ),
            3 => 
            array (
                'id' => 4,
                ...
                'status' => '1',
                'created_at' => '2020-11-30 07:48:46',
                'updated_at' => '2020-12-01 09:43:20',
            ),
        ));
